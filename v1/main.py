...
class Jeu:
    def __init__(self):
        ...
        self.perso = perso.Perso(size * 25, size * 20, size)
    ...
    def tick(self):
        ...
        self.perso.input(self.map, delta, z, q, s, d, pg.mouse.get_pos())
        self.perso.view_ray(self.map)
    ...
    def render(self): # appel à d'autres fonctions self.render_*() pour l'affichage
        ...
        self.projection.draw(self.screen, self.perso.get_views())
